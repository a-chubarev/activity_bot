...
def add_admin_table_intersection(message: types.Message):
    ...
    if chat_controls.check_member_is_admin(message):
        user_is_admin = '+'
    else:
        user_is_admin = '-'
...
def update_admin_table_intersection(message: types.Message):
